...
export default function About() {
  return (
    <section id="about" className="border-b border-[#101418]/10 py-24 lg:py-32">
      <div className={`${wrap} grid grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-16`}>
        <Reveal className="lg:col-span-7">
          ...
          <p className="mt-6 max-w-[560px] leading-relaxed text-[#101418]/65">{agency.text}</p>
          <div className="mt-8">
        ...
        <div className="flex flex-col gap-4 lg:col-span-5">
          {agency.points.map((pt, i) => (
            <Reveal key={pt}>
              <div className="card flex items-center gap-4 rounded-2xl border border-[#101418]/10 bg-white p-6">
                <span className="font-mono text-2xl font-bold text-[var(--brand)]">0{i + 1}</span>
