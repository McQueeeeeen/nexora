...
export default function Cta() {
  ...
  return (
    <div className="relative" style={{ height: "200vh" }}>
      <section ref={sectionRef} className="sticky top-0 flex h-screen w-full items-center justify-center overflow-hidden" style={{ background: "#2A211D" }}>
        <div className="relative mx-auto flex w-full max-w-[1408px] flex-col items-center gap-6 px-6 text-center lg:px-12">
          <span ref={eyebrowRef} className="font-mono text-[11px] uppercase tracking-[1px] text-[#FBF9F5]/70" style={{ opacity: 0, willChange: "opacity" }}>
            Готовы, когда вы готовы
          </span>
          <div className="relative flex w-full items-center justify-center">
            <h2 className="max-w-[1100px] text-[40px] font-normal leading-[0.96] tracking-[-1.4px] text-[#FBF9F5] sm:text-[64px] lg:text-[112px]">
              Следующий шаг — самый лёгкий.
            </h2>
            <span ref={bgWordRef} aria-hidden className="absolute inline-block text-[120px] font-normal leading-none tracking-[-4px] text-[#FBF9F5] sm:text-[200px] lg:text-[320px] lg:tracking-[-12px]"
              style={{ transform: "translateY(130px)", opacity: 0.12, willChange: "transform" }}>
              NEXORA®
            </span>
          </div>
          <Btn href={`${pre}#contact`} light className="mt-2 h-16 rounded-xl px-8 text-base font-semibold">
