  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 px-4 pb-[calc(0.9rem+env(safe-area-inset-bottom))] pt-6 transition-transform duration-300 ease-out lg:hidden"
      ...
      style={{
        ...
        background: "linear-gradient(to top, #FBF9F5f2, transparent)",
      }}>
      <div className="flex gap-2">
        <a href="https://t.me/nexora_support" target="_blank" rel="noopener"
          className="flex h-12 flex-1 items-center justify-center rounded-xl border border-[#2A211D]/15 bg-white/85 text-sm font-semibold text-[#2A211D] backdrop-blur-md">
          Telegram
        </a>
