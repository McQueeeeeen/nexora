...
2. **Цены**: консультация €10 уже на сайте; остальную ценокатегорию распишет владелец — затем добавить прайсинг-блок.
3. **Отзывы**: нужны реальные тексты (минимум +3). Не выдумываем.
4. **Блог**: пополнять гайдами (структура готова: app/blog/posts.ts).
