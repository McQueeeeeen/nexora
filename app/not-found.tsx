...
export default function NotFound() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-[#F7F5EF] px-6 text-center text-[#101418]">
      <span className="font-mono text-sm font-bold uppercase tracking-[2px] text-[var(--brand)]">404</span>
      <h1 className="mt-4 max-w-[640px] text-4xl font-medium tracking-tight sm:text-6xl">Такой страницы нет</h1>
      <p className="mt-4 max-w-[420px] text-[#101418]/60">Возможно, адрес изменился. Вернитесь на главную — там вузы, гранты и бесплатный аудит.</p>
