...
export const agency = {
  ...
  text: "Пять лет сопровождаем студентов в Австрию и Венгрию: от первой консультации и академического аудита до зачисления и карточки ВНЖ. Работаем полностью удалённо — на связи каждый день.",
