...
export const nav = [
  ["Направления", "#services"], ["База вузов", "#database"], ["Цены", "/pricing"], ["Этапы", "#steps"],
  ["Отзывы", "#reviews"], ["FAQ", "/faq"], ["Контакты", "#contact"],
] as const;

export const agency = {
  tag: "Агентство",
  heading: "Агентство по поступлению за рубеж",
  text: "Сопровождаем студентов в государственные, частные университеты и колледжи: от первой консультации и академического аудита до зачисления и карточки ВНЖ. Работаем полностью удалённо — на связи каждый день.",
  points: ["100% удалённо, без лишней бюрократии", "312+ успешных зачислений за 5 лет", "Персональный куратор от аудита до ВНЖ"],
};

export const heroPhrases = [
  { t: "Поступление в вузы Европы — от первой консультации до визы.", img: "https://images.unsplash.com/photo-1516550893923-42d28e5677af?auto=format&fit=crop&w=1920&q=75", label: "Вена" },
  { t: "Гранты, дедлайны и зачисление без риска отказа.", img: "https://images.unsplash.com/photo-1541849546-216549ae216d?auto=format&fit=crop&w=1920&q=75", label: "Будапешт" },
  { t: "Австрия и Венгрия — один куратор на весь путь.", img: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&w=1920&q=75", label: "Студенты" },
];

export const services = [
  { no: "Направление 01", title: "Бакалавриат в Австрии", desc: "от €1 450/год · VWU с нуля", text: "Государственные университеты Вены, Граца и Линца от €1 450/год. Поступление после 11 классов, подготовительное отделение (VWU) и программы на немецком и английском языках.", img: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&w=800&q=75" },
  { no: "Направление 02", title: "Гранты в Венгрии", desc: "грант 100% · всё включено", text: "Stipendium Hungaricum: 100% бесплатное обучение, ежемесячная стипендия, бесплатное общежитие и медицинская страховка. Полная подготовка конкурсного портфолио.", img: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=800&q=75" },
  { no: "Направление 03", title: "Магистратура и MBA", desc: "120+ программ на английском", text: "Ведущие университеты (WU Vienna, TU Wien, Corvinus, ELTE). Более 120 программ полностью на английском языке с прямым зачислением без потери семестра.", img: "https://images.unsplash.com/photo-1523580494863-6f3031224c94?auto=format&fit=crop&w=800&q=75" },
...
export const countries: Record<string, CountryInfo> = {
  austria: {
    ...
    whyPoints: [
      ...
      { title: "Куратор на связи", desc: "Помогаем с общежитием и ВНЖ удалённо" },
    ],
    ...
    ctaImg: "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?auto=format&fit=crop&w=1920&q=75",
  },
  hungary: {
    ...
    whyPoints: [
      ...
      { title: "Куратор на связи", desc: "Помогаем с заселением удалённо" },
    ],
    includedTitle: "Что входит в сопровождение",
...
export const stats = [
  ...
  { top: "ГРАНТЫ", mid: "100%", bot: "Покрытие учёбы Stipendium Hungaricum" },
...
export const faqCats = ["Все", "Поступление", "Гранты и цены", "ВНЖ и переезд", "Гарантии"] as const;

export const faqs: { q: string; a: string; cat: string }[] = [
  { cat: "Гранты и цены", q: "Сколько стоит высшее образование в Австрии и Венгрии?", a: "В государственных вузах Австрии обучение для граждан не-ЕС стоит ~€1\u00A0450 в год (~€726 за семестр). В Венгрии по стипендии Stipendium Hungaricum обучение 100% бесплатное, а на коммерческой основе — от €2 500 до €5 000 в год." },
  { cat: "Поступление", q: "Можно ли поступить без знания немецкого языка?", a: "Да! В Австрии действует подготовительное отделение (Vorstudienlehrgang / VWU), где можно учить немецкий язык с нуля при университете. Также доступно множество программ бакалавриата и магистратуры на английском языке." },
  { cat: "Гранты и цены", q: "Что покрывает грант Stipendium Hungaricum в Венгрии?", a: "Грант покрывает 100% стоимости обучения, предоставляет бесплатное проживание в студенческом общежитии (или компенсацию аренды), ежемесячную стипендию и медицинскую страховку на весь период учебы." },
  { cat: "Поступление", q: "Когда нужно начинать подготовку к поступлению?", a: "Рекомендуем начинать за 6–9 месяцев до дедлайна. Для гранта в Венгрии приём документов закрывается в январе, а для Австрии основной летний прием идет в июле–октябре." },
  { cat: "ВНЖ и переезд", q: "Помогаете ли вы с получением студенческого ВНЖ?", a: "Да. Мы сопровождаем весь процесс оформления студенческого ВНЖ (Aufenthaltsbewilligung): проверяем справки из банка, бронируем общежитие и готовим к подаче в посольство." },
  { cat: "Гарантии", q: "Какие гарантии зачисления вы предоставляете?", a: "В договоре фиксируется подбор программ разного уровня селективности, включая гарантированные варианты. 98.4% наших студентов успешно получают зачисление." },
  { cat: "Поступление", q: "Берёте ли после 9 классов или колледжа?", a: "В Австрию нужен аттестат за 11 классов (разницу закрывает VWU), в Венгрии есть программы после колледжа. Пришлите документы — скажем точно по вашему профилю на консультации за €10." },
  { cat: "Поступление", q: "Что входит в сопровождение под ключ?", a: "Аудит, шортлист вузов, переводы и апостили, нострификация, мотивационные письма, подача заявок, общежитие и студенческий ВНЖ. Вы только приходите на консультацию и собираете чемодан." },
  { cat: "ВНЖ и переезд", q: "Где будет жить студент?", a: "Бронируем общежитие до подачи на ВНЖ: в Вене от ~€400, в Будапеште (особенно по гранту) — бесплатно. Помогаем и с арендой, если общежитие не подойдёт." },
  { cat: "Гарантии", q: "Что будет, если не зачислят?", a: "Шортлист всегда включает гарантированные варианты, поэтому без места не остаются. Если топ-программа отказала — разбираем причину и подаём на следующий поток бесплатно." },
];
