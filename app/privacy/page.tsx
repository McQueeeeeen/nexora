...
const blocks: [string, string][] = [
  ...
  ["Зачем они нужны", "Единственная цель — связаться с вами по заявке: бесплатный аудит шансов, дедлайны и план поступления. Ни спама, ни передачи третьим лицам для маркетинга."],
